...
if __name__ == "__main__":
    run_inference(
        ...
        protein_lmdb="/path/to/protein_lmdb",
        smi_lmdb="/path/to/smi_lmdb",
        model_paths=["/path/to/Model/KCAT/kcat_1.json",
                     "/path/to/Model/KCAT/kcat_2.json",
                     "/path/to/Model/KCAT/kcat_3.json",
                     "/path/to/Model/KCAT/kcat_4.json",
                     "/path/to/Model/KCAT/kcat_5.json",
                     "/path/to/Model/KCAT/kcat_6.json",
                     "/path/to/Model/KCAT/kcat_7.json",
                     "/path/to/Model/KCAT/kcat_8.json",
                     "/path/to/Model/KCAT/kcat_9.json",
                     "/path/to/Model/KCAT/kcat_10.json",],
