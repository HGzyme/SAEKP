...
def main():
    ...
    parser.add_argument('--dataset', type=str, default = 'v3-2_all', help='root directory of dataset. For now, only classification.')
    ...
    env = lmdb.open('/remote-home/lzy_new/catpred/kcat_lzy/Data_v3_final/v3_20250418/kfold/Smi_molebert_lmdb', map_size=1073741824)
